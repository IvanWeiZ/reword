...
export const MOCK_FLAGGED_RESULT: AnalysisResult = {
  ...
  rewrites: [
    {
      label: 'Warmer',
      text: 'That works for me! I was looking forward to our original plan though — can we reschedule?',
    },
    {
      label: 'Direct but kind',
      text: "Honestly I'm a little disappointed, but I understand. Let's find another time.",
    },
